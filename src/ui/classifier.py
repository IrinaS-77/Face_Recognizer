    ...
    def __init__(self, **kwargs):
        ...
        for database in ALL_DATABASES: 
            btn = Button(
                ...
                background_color = (0.36, 0.36, 0.37, .9))
            btn.bind(on_release = lambda btn: self.dropdown_databases.select(btn.text)) 
            self.dropdown_databases.add_widget(btn) 
        self.list_databases = Button(text ='Базы', size_hint=(.05, .5), pos_hint={"center_y":.5}, background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.bth_group_left = Button(text='<- Пред. группа', on_press=self.group_left, background_color = (0.17, 0.17, 0.17, .9))
        self.bth_group_right = Button(text='След. группа ->', on_press=self.group_right, background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.bth_img_left = Button(text='<- Пред. изображение', on_press=self.img_left, background_color = (0.17, 0.17, 0.17, .9))
        self.bth_img_right = Button(text='След. изображение ->', on_press=self.img_right, background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.box_control_db_search_title = Label(text='База поиска', size_hint=(1,0.2), color = (0, 0, 0, ))
        ...
        self.bth_run_method = Button(text='Рассчитать', on_press=self.run_method,
            background_color = (0.17, 0.17, 0.17, .9), size_hint = (1, 0.5))
        self.bth_run_recognition = Button(text='Распознать', on_press=self.run_recognition,
            background_color = (0, 1, 0.28, .9), size_hint = (1, 0.5))
        ...
        self.list_methods = Button(text ='Признаки', size_hint=(.6, .5), pos_hint={"center_y":.5}, background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.method_param_name = Label(text=METHODS_PARAM[self.method]['name'], color = (0, 0, 0, ),
            size_hint=(.05, .5), pos_hint={"center_y":.5})
        self.method_param = TextInput(text=METHODS_PARAM[self.method]['default'],
            size_hint=(.10, .5), pos_hint={"center_y":.5},
