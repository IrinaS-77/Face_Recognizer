...
class MainBox(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.list_databases = Button(text ='Базы', size_hint=(.1, 1), background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.list_methods = Button(text ='Методы', size_hint=(.1, 1), background_color = (0.17, 0.17, 0.17, .9))
        ...
        self.list_researches = Button(text ='Исследования', size_hint=(.1, 1), background_color = (0.17, 0.17, 0.17, .9))
